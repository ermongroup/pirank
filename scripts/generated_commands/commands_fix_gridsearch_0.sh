# Experiment fix_gridsearch, iteration 0
# {"num_train_steps": 100000, "data": ["mslr"], "topks": [10], "list_sizes": [100], "batch_sizes": [16], "learning_rates": [0.1, 0.001, 1e-05], "optimizers": ["Adam", "Adagrad"], "dropout_rates": [0.3, 0.6], "temperatures": [0.1, 1, 10, 1000.0], "architectures": {"tfr": "1024,512,256"}, "losses": ["pirank_simple"]}
